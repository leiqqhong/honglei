...
<div id="header" class="wrap">
	...
	<div class="help"><a href="shopping.jsp" class="shopping">购物车X件</a>
	<a href="login.jsp">登录</a><a href="register.jsp">注册</a>
	<a href="guestbook.jsp">留言</a><a href="manage/index.jsp">后台管理</a>
	</div>
	<div class="navbar">
		<ul class="clearfix">
...
<div id="position" class="wrap">
	您现在的位置：<a href="EasybuyCommentServlet?opr=findAllComment">易买网</a> &gt; 在线留言
</div>
	...
	<div class="main">
		<div class="guestbook">
			...
			<ul>
				...
				<li>
					<dl>
						<dt>${guestbook.content}</dt>
						<dd class="author">${guestbook.nickName}<span class="timer">${guestbook.createTime}</span></dd>
						<dd>${guestbook.reply}</dd>
					</dl>
				</li>
				</c:forEach>
			</ul>
			...
			<div id="reply-box">
				<form id="guestBook" method="post" action="EasybuyCommentServlet?opr=addEasybuyComment">
					<table>
						<tr>
							<td class="field">昵称：</td>
							<td><input class="text" type="text" name="guestName" disabled="disabled" value="当前用户"/></td>
						</tr>						
						<tr>
